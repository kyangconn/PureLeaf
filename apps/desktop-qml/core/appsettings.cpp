...
AppSettings loadAppSettings() {
    ...
    settings.controlsStyle =
        stringValue(appearance, QStringLiteral("controlsStyle"), defaults.controlsStyle);
...
void saveAppSettings(const AppSettings& settings) {
    ...
    appearance.insert(QStringLiteral("controlsStyle"), settings.controlsStyle);
